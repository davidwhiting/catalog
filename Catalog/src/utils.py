...
def initialize_student_data_ZZ():
    """
    Initialize new student data
    (This is not the same as populating from the database)
    """
...
async def populate_student_info_dict_ZZ(timed_connection, user_id, default_first_term='Spring 2024'):
    """
...
async def populate_student_data_dict_ZZ(timed_connection, student_info):
    """
